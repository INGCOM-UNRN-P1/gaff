...
### Qué cubre
- Linter pedagógico de estilo y convenciones arquitectónicas obligatorias de la cátedra, cubriendo 115 reglas de catálogo (`0x00XXh` a `0x50XXh`).
...
- Árbol de ejemplos canónicos (`examples/`) con un archivo para cada una de las 115 reglas verificadas.
