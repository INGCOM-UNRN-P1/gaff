...
CATALOGO_REGLAS: Dict[str, Dict[str, Any]] = {
    ...
    "0x0037h": {
        "codigo": "0x0037h",
        "titulo": "Evitá identificadores genéricos con sufijo numérico o afijos (numero1, num_1, n_a, a_n)",
        "descripcion": "Los identificadores genéricos seguidos de un número o combinados con afijos (como 'numero1', 'numero_1', 'num1', 'n_a', 'a_n', 'var1', 'dato1', etc.) denotan una elección pobre de nombres y falta de abstracción. Usá nombres que reflejen el rol semántico específico o utilizá un arreglo si representan una colección.",
    ...
    "0x001Ah": {
        "codigo": "0x001Ah",
        "alias": "GAFF_0x001Ah",
        "titulo": "Prohibición de espacios en blanco alrededor de operadores de acceso a miembros (-> y .)",
        "categoria": "Sintaxis Básica y Nomenclatura (0x00XX)",
        "archivo_apunte": "0_sintaxis.md",
        "descripcion": "Los operadores de acceso a campos de estructuras y uniones ('->' y '.') no deben llevar espacios en blanco a ninguno de sus lados.",
        "ejemplo_correcto": "nodo->sig = punto.x;",
        "ejemplo_incorrecto": "nodo -> sig = punto . x;",
        "autofix": "Sí",
    },
    "0x001Bh": {
        "codigo": "0x001Bh",
        "alias": "GAFF_0x001Bh",
        "titulo": "Prohibición de espacios en blanco entre operadores unarios (++, --, !) y su operando",
        "categoria": "Sintaxis Básica y Nomenclatura (0x00XX)",
        "archivo_apunte": "0_sintaxis.md",
        "descripcion": "Los operadores unarios de incremento, decremento y negación lógica deben estar adheridos a su operando sin separación de espacios en blanco.",
        "ejemplo_correcto": "i++;\n++j;\nif (!activo) { ... }",
        "ejemplo_incorrecto": "i ++;\n++ j;\nif (! activo) { ... }",
        "autofix": "Sí",
    },
    "0x001Ch": {
        "codigo": "0x001Ch",
        "alias": "GAFF_0x001Ch",
        "titulo": "Espacio en blanco obligatorio tras la coma separadora en listas y argumentos",
        "categoria": "Sintaxis Básica y Nomenclatura (0x00XX)",
        "archivo_apunte": "0_sintaxis.md",
        "descripcion": "Toda coma ',' utilizada para separar argumentos de función, parámetros o declaraciones múltiples debe estar seguida por exactamente un espacio en blanco.",
        "ejemplo_correcto": "int a, b = 0;\nfoo(x, y, z);",
        "ejemplo_incorrecto": "int a,b = 0;\nfoo(x,y,z);",
        "autofix": "Sí",
    },
    "0x001Dh": {
        "codigo": "0x001Dh",
        "alias": "GAFF_0x001Dh",
        "titulo": "Prohibición de espacios en blanco internos inmediatamente tras '(' o antes de ')'",
        "categoria": "Sintaxis Básica y Nomenclatura (0x00XX)",
        "archivo_apunte": "0_sintaxis.md",
        "descripcion": "No deben dejarse espacios en blanco inmediatamente tras el paréntesis de apertura ni antes del paréntesis de cierre en expresiones, condiciones o invocaciones.",
        "ejemplo_correcto": "if (x > 0) {\n    foo(a, b);\n}",
        "ejemplo_incorrecto": "if ( x > 0 ) {\n    foo( a, b );\n}",
        "autofix": "Sí",
    },
    "0x001Eh": {
        "codigo": "0x001Eh",
        "alias": "GAFF_0x001Eh",
        "titulo": "Prohibición de múltiples espacios en blanco consecutivos dentro de una línea de código",
        "categoria": "Sintaxis Básica y Nomenclatura (0x00XX)",
        "archivo_apunte": "0_sintaxis.md",
        "descripcion": "Salvo la sangría inicial que delimita los bloques, no deben colocarse dos o más espacios consecutivos entre identificadores, operadores o palabras clave.",
        "ejemplo_correcto": "int total = cantidad * precio;",
        "ejemplo_incorrecto": "int   total   =   cantidad  *  precio;",
        "autofix": "Sí",
    },
    "0x3016h": {
        "codigo": "0x3016h",
        "alias": "GAFF_0x3016h",
        "titulo": "Orden incorrecto o sospechoso de argumentos en llamadas a memset",
        "categoria": "Punteros y Gestión de Memoria (0x30XX)",
        "descripcion": "En memset(ptr, val, size), el segundo argumento es el valor byte a escribir y el tercero es la cantidad de bytes. Invertir estos argumentos es un error pedagógico común que no inicializa la memoria.",
        "ejemplo_correcto": "memset(buffer, 0, sizeof(buffer));",
        "ejemplo_incorrecto": "memset(buffer, sizeof(buffer), 0);",
        "autofix": "Sí",
    },
    "0x100Ch": {
        "codigo": "0x100Ch",
        "alias": "GAFF_0x100Ch",
        "titulo": "Evitar comparaciones en estilo Yoda ('CONST == variable')",
        "categoria": "Estructuras de Control y Lazos (0x10XX)",
        "descripcion": "Las comparaciones en estilo Yoda ('NULL == ptr', '0 == x') dificultan la lectura natural del flujo lógico. Con compiladores modernos (-Wall), escribir 'variable == CONST' es seguro e idiomático.",
        "ejemplo_correcto": "if (ptr == NULL || count == 0) { ... }",
        "ejemplo_incorrecto": "if (NULL == ptr || 0 == count) { ... }",
        "autofix": "Sí",
    },
    "0x200Eh": {
        "codigo": "0x200Eh",
        "alias": "GAFF_0x200Eh",
        "titulo": "Comentarios de cierre explicativos en bloques de control extensos (> 25 líneas)",
        "categoria": "Funciones y Modularización (0x20XX)",
        "descripcion": "En estructuras de control o funciones que abarcan más de 25 líneas, debe agregarse un comentario en la llave de cierre para facilitar la lectura del anidamiento (ej: '} // end while (cond)' o '} // end funcion').",
    ...
    "0x5011h": {
        "codigo": "0x5011h",
        "alias": "GAFF_0x5011h",
        "titulo": "Colisión de nombres de macroguardas entre archivos de cabecera distintos",
        "categoria": "Compilación y Buenas Prácticas de Ingeniería (0x50XX)",
        "descripcion": "Dos o más archivos de cabecera (.h) no deben definir exactamente la misma macro de guarda (#ifndef / #define), ya que provocaría que uno de ellos sea ignorado por el preprocesador.",
        "ejemplo_correcto": "// En utils_a.h: __UTILS_A_H__; en utils_b.h: __UTILS_B_H__",
        "ejemplo_incorrecto": "// En ambos archivos: __UTILS_H__",
        "autofix": "No",
    },
    "0x200Fh": {
        "codigo": "0x200Fh",
        "alias": "GAFF_0x200Fh",
        "titulo": "Uso obligatorio de 'void' explícito en funciones sin parámetros",
        "categoria": "Funciones y Modularización (0x20XX)",
        "descripcion": "En C estándar, una declaración 'int f()' indica un número indeterminado de parámetros (estilo K&R). Debe utilizarse siempre 'int f(void)' para declarar explícitamente ausencia de argumentos.",
        "ejemplo_correcto": "int obtener_contador(void);",
        "ejemplo_incorrecto": "int obtener_contador();",
        "autofix": "Sí",
    },
    "0x100Dh": {
        "codigo": "0x100Dh",
        "alias": "GAFF_0x100Dh",
        "titulo": "Prohibición de casts de tipo innecesarios o redundantes",
        "categoria": "Estructuras de Control y Lazos (0x10XX)",
        "descripcion": "Castear literales compatibles o variables al mismo tipo exacto ensucia el código y dificulta la comprensión sintáctica.",
        "ejemplo_correcto": "int x = 0;",
        "ejemplo_incorrecto": "int x = (int)0;",
        "autofix": "Sí",
    },
    "0x100Eh": {
        "codigo": "0x100Eh",
        "alias": "GAFF_0x100Eh",
        "titulo": "Espaciado obligatorio alrededor de operadores ternarios ('? :')",
        "categoria": "Estructuras de Control y Lazos (0x10XX)",
        "descripcion": "Debe colocarse exactamente un espacio antes y después del signo de interrogación y de los dos puntos en operadores ternarios condicionales.",
        "ejemplo_correcto": "int min = (a < b) ? a : b;",
        "ejemplo_incorrecto": "int min = (a < b)?a:b;",
        "autofix": "Sí",
    },
    "0x3017h": {
        "codigo": "0x3017h",
        "alias": "GAFF_0x3017h",
        "titulo": "Orden canónico de calificadores: 'const tipo' en lugar de 'tipo const'",
        "categoria": "Punteros y Gestión de Memoria (0x30XX)",
        "descripcion": "Por convención institucional de cátedra, los calificadores const deben preceder al tipo de dato básico ('const int x' en lugar de 'int const x').",
        "ejemplo_correcto": "const int MAXIMO = 100;",
        "ejemplo_incorrecto": "int const MAXIMO = 100;",
        "autofix": "Sí",
    },
    "0x5012h": {
        "codigo": "0x5012h",
        "alias": "GAFF_0x5012h",
        "titulo": "Prohibición de directivas #pragma no estándar o privativas",
        "categoria": "Compilación y Buenas Prácticas de Ingeniería (0x50XX)",
        "descripcion": "Evitar directivas #pragma específicas de compiladores cerrados (como #pragma warning, #pragma comment de MSVC). Emplear flags estándar de compilador en GCC/Clang.",
        "ejemplo_correcto": "// Uso de flags -Wall -Wextra en Makefile",
        "ejemplo_incorrecto": "#pragma warning(disable: 4996)",
        "autofix": "No",
    },
    "0x0015h": {
        "codigo": "0x0015h",
        "alias": "GAFF_0x0015h",
        "titulo": "Alineación vertical consistente en asignaciones y declaraciones consecutivas",
        "categoria": "Sintaxis Básica y Nomenclatura (0x00XX)",
        "descripcion": "En bloques de 3 o más declaraciones o asignaciones consecutivas, mantener una estructura ordenada sin indentaciones dispares.",
    ...
    "0x3018h": {
        "codigo": "0x3018h",
        "alias": "GAFF_0x3018h",
        "titulo": "Inicialización idiomática de agregados con {0} en lugar de memset inmediato",
        "categoria": "Punteros y Gestión de Memoria (0x30XX)",
        "descripcion": "Las variables locales de tipo struct o array deben inicializarse a cero idiomáticamente en su declaración mediante '{0}' en lugar de emitir una llamada posterior a memset.",
        "ejemplo_correcto": "struct punto_t p = {0};",
        "ejemplo_incorrecto": "struct punto_t p;\nmemset(&p, 0, sizeof(p));",
        "autofix": "No",
    },
    "0x0038h": {
        "codigo": "0x0038h",
        "alias": "GAFF_0x0038h",
        "titulo": "Prohibición de constantes numéricas mágicas en índices de arreglos",
        "categoria": "Sintaxis Básica y Nomenclatura (0x00XX)",
        "descripcion": "No acceder a posiciones fijas de un arreglo con números literales mayores a 2 (ej: vec[7]). Utilizar constantes simbólicas con significado de dominio (#define o enum).",
        "ejemplo_correcto": "registro[INDICE_TOTAL] = 100;",
        "ejemplo_incorrecto": "registro[7] = 100;",
        "autofix": "No",
    },
    "0x2010h": {
        "codigo": "0x2010h",
        "alias": "GAFF_0x2010h",
        "titulo": "Prohibición de paréntesis superfluos en sentencia return",
        "categoria": "Funciones y Modularización (0x20XX)",
        "descripcion": "En lenguaje C, 'return' es una palabra clave de control de flujo, no una llamada a función. Los paréntesis envolventes ('return (x);') son redundantes y deben eliminarse.",
        "ejemplo_correcto": "return resultado;",
        "ejemplo_incorrecto": "return (resultado);",
        "autofix": "Sí",
    },
    "0x0017h": {
        "codigo": "0x0017h",
        "alias": "GAFF_0x0017h",
        "titulo": "Espaciado consistente en declaraciones de doble puntero (tipo **var)",
        "categoria": "Sintaxis Básica y Nomenclatura (0x00XX)",
        "descripcion": "En declaraciones de tipos puntero a puntero, los asteriscos deben ir unidos entre sí y junto al identificador ('char **argv'), evitando 'char* *argv', 'char * * argv' o 'char** argv'.",
        "ejemplo_correcto": "int main(int argc, char **argv)",
        "ejemplo_incorrecto": "int main(int argc, char** argv)",
        "autofix": "Sí",
    },
    "0x5014h": {
        "codigo": "0x5014h",
        "alias": "GAFF_0x5014h",
        "titulo": "Detección de inclusiones cíclicas entre archivos de cabecera",
        "categoria": "Compilación y Buenas Prácticas de Ingeniería (0x50XX)",
        "descripcion": "Dos o más archivos de cabecera no deben incluirse mutuamente en ciclo, ya que provoca dependencias cruzadas y orden de declaración indefinido.",
        "ejemplo_correcto": "Uso de forward declarations (struct nodo_t;) en cabeceras dependientes.",
        "ejemplo_incorrecto": "a.h incluye b.h y b.h incluye a.h",
        "autofix": "No",
    },
    "0x5013h": {
        "codigo": "0x5013h",
        "alias": "GAFF_0x5013h",
        "titulo": "Prohibición de declaraciones extern en archivos de implementación (.c)",
        "categoria": "Compilación y Buenas Prácticas de Ingeniería (0x50XX)",
        "descripcion": "Las variables o funciones compartidas declaradas con 'extern' dentro de un archivo .c eluden la verificación estricta de tipos de la cabecera. Deben formalizarse en un header (.h).",
        "ejemplo_correcto": "#include \"modulo_config.h\" // contiene extern int g_config;",
        "ejemplo_incorrecto": "extern int g_config; // en medio de main.c",
        "autofix": "No",
    },
    "0x2012h": {
        "codigo": "0x2012h",
        "alias": "GAFF_0x2012h",
        "titulo": "Prohibición de asignaciones múltiples a una variable sin lectura intermedia (dead store)",
        "categoria": "Funciones y Modularización (0x20XX)",
        "descripcion": "Asignar consecutivamente valores a una variable sin realizar lecturas intermedias descarta el valor previo sin efecto útil, indicando errores de lógica, código residual o asignaciones redundantes.",
        "ejemplo_correcto": "int valor = 10;\nprintf(\"%d\\n\", valor);\nvalor = 20;",
        "ejemplo_incorrecto": "int valor = 10;\nvalor = 20; // Dead store: el 10 nunca fue leído",
        "autofix": "No",
    },
    "0x5015h": {
        "codigo": "0x5015h",
        "alias": "GAFF_0x5015h",
        "titulo": "Protección obligatoria con paréntesis envolventes en expresiones de macroconstantes (#define)",
        "categoria": "Compilación y Buenas Prácticas de Ingeniería (0x50XX)",
        "descripcion": "Las expresiones aritméticas, lógicas o condicionales en directivas #define deben encerrarse en paréntesis protectores ((expresión)) para evitar ambigüedades y errores de precedencia al expandirse.",
        "ejemplo_correcto": "#define TAM ((10) + (5))\n#define MAX_BUFFER (1024 * 2)",
        "ejemplo_incorrecto": "#define TAM 10 + 5\n#define MAX_BUFFER 1024 * 2",
        "autofix": "Sí",
    },
    "0x001Fh": {
        "codigo": "0x001Fh",
        "alias": "GAFF_0x001Fh",
        "titulo": "Prohibición de llaves redundantes en inicialización de tipos escalares",
        "categoria": "Sintaxis Básica y Nomenclatura (0x00XX)",
        "descripcion": "El uso de llaves de inicialización de agregados ({0}) se reserva exclusivamente para structs y arreglos. Las variables escalares (enteros, caracteres, flotantes, punteros) deben inicializarse directamente con su valor literal sin llaves redundantes.",
        "ejemplo_correcto": "int contador = 0;\nfloat tasa = 0.0f;\nstruct punto_t p = {0};",
        "ejemplo_incorrecto": "int contador = {0};\nfloat tasa = {0.0};",
        "autofix": "Sí",
    },
    "0x1012h": {
        "codigo": "0x1012h",
        "alias": "GAFF_0x1012h",
        "titulo": "Prohibición de comparaciones encadenadas no idiomáticas en C (a < b < c)",
        "categoria": "Estructuras de Control y Lazos (0x10XX)",
        "descripcion": "En C las comparaciones encadenadas como 'a < b < c' no verifican la relación matemática conjunta, sino que evalúan '(a < b) < c' (comparando un booleano contra c). Deben escribirse explícitamente con '&&'.",
        "ejemplo_correcto": "if (a < b && b < c)",
        "ejemplo_incorrecto": "if (a < b < c)\nif (0 <= x <= 10)",
        "autofix": "Sí",
    },
    "0x1013h": {
        "codigo": "0x1013h",
        "alias": "GAFF_0x1013h",
        "titulo": "Prohibición de saltos no estructurados goto fuera del patrón canónico de liberación de recursos",
        "categoria": "Estructuras de Control y Lazos (0x10XX)",
        "descripcion": "Los saltos con 'goto' hacia atrás (backwards jumps) simulando lazos no estructurados o saltos a etiquetas intermedias están estrictamente prohibidos. Solo se tolera excepcionalmente el salto hacia adelante a un bloque terminal de liberación de recursos.",
        "ejemplo_correcto": "if (!res) goto cleanup;\n// ...\ncleanup:\n    free(p);\n    return false;",
        "ejemplo_incorrecto": "loop:\n    // ...\n    goto loop; // Salto hacia atrás prohibido",
        "autofix": "No",
    },
    "0x2013h": {
        "codigo": "0x2013h",
        "alias": "GAFF_0x2013h",
        "titulo": "Tipo de retorno obligatorio 'int' en la función main()",
        "categoria": "Funciones y Modularización (0x20XX)",
        "descripcion": "La función de punto de entrada 'main' debe declarar obligatoriamente 'int' como tipo de retorno conforme a los estándares ISO C99/C11/C23. El uso de 'void main' es inválido y no portable.",
    ...
    "0x0022h": {
        "codigo": "0x0022h",
        "alias": "GAFF_0x0022h",
        "titulo": "Validador de espaciado estricto en sentencias de control",
        "categoria": "Sintaxis Básica y Nomenclatura (0x00XX)",
        "descripcion": "Debe existir exactamente un espacio en blanco entre las palabras clave 'if', 'for', 'while', 'switch' y el paréntesis de apertura de su condición ('if (...)', no 'if(...)').",
        "ejemplo_correcto": "if (x > 0) {\n    return 1;\n}",
        "ejemplo_incorrecto": "if(x > 0) {\n    return 1;\n}",
        "autofix": "Sí",
    },
    "0x0023h": {
        "codigo": "0x0023h",
        "alias": "GAFF_0x0023h",
        "titulo": "Detector de variables locales no inicializadas con modificador const",
        "categoria": "Sintaxis Básica y Nomenclatura (0x00XX)",
        "descripcion": "Toda variable declarada con el calificador 'const' debe inicializarse inmediatamente en su sentencia de declaración.",
        "ejemplo_correcto": "const int limite = 100;",
        "ejemplo_incorrecto": "const int limite; // No inicializada",
        "autofix": "No",
    },
    "0x0025h": {
        "codigo": "0x0025h",
        "alias": "GAFF_0x0025h",
        "titulo": "Validador de formato canónico en firmas de punteros a función",
        "categoria": "Sintaxis Básica y Nomenclatura (0x00XX)",
        "descripcion": "Las declaraciones y typedefs de punteros a función deben seguir el formato canónico 'tipo (*identificador)(params)' sin espacios dispersos alrededor del asterisco.",
        "ejemplo_correcto": "typedef int (*operacion_t)(int, int);",
        "ejemplo_incorrecto": "typedef int (* operacion_t )(int, int);",
        "autofix": "No",
    },
    "0x0026h": {
        "codigo": "0x0026h",
        "alias": "GAFF_0x0026h",
        "titulo": "Auditor de identificadores reservados con doble guion bajo o guion bajo inicial",
        "categoria": "Sintaxis Básica y Nomenclatura (0x00XX)",
        "descripcion": "Los identificadores que comienzan con doble guion bajo ('__') o con guion bajo seguido de mayúscula ('_A') están estrictamente reservados para la biblioteca estándar y el compilador.",
        "ejemplo_correcto": "int contador_local = 0;",
        "ejemplo_incorrecto": "int __variable_privada = 0;\nint _Buffer = 0;",
        "autofix": "No",
    },
    "0x0027h": {
        "codigo": "0x0027h",
        "alias": "GAFF_0x0027h",
        "titulo": "Validador de presencia de cabecera de documentación obligatoria por archivo",
        "categoria": "Sintaxis Básica y Nomenclatura (0x00XX)",
        "descripcion": "Todo archivo fuente o cabecera debe comenzar con un bloque de documentación inicial que detalle autoría, cátedra o propósito del módulo.",
        "ejemplo_correcto": "/*\n * Cátedra de Programación 1\n * Módulo: lista.c\n */",
        "ejemplo_incorrecto": "// (archivo sin cabecera institucional)",
        "autofix": "No",
    },
    "0x0028h": {
        "codigo": "0x0028h",
        "alias": "GAFF_0x0028h",
        "titulo": "Detector de etiquetas de salto goto no alineadas al margen izquierdo",
        "categoria": "Sintaxis Básica y Nomenclatura (0x00XX)",
        "descripcion": "Las etiquetas de salto para gestión de errores deben situarse al margen izquierdo (columna 1) para facilitar su identificación visual como puntos de salto.",
        "ejemplo_correcto": "cleanup:\n    free(buffer);\n    return;",
        "ejemplo_incorrecto": "    cleanup:\n        free(buffer);",
        "autofix": "No",
    },
    "0x0029h": {
        "codigo": "0x0029h",
        "alias": "GAFF_0x0029h",
        "titulo": "Auditor de inicialización de arreglos unidimensionales con exceso de elementos",
        "categoria": "Sintaxis Básica y Nomenclatura (0x00XX)",
        "descripcion": "La lista de inicialización de un arreglo estático no debe contener más elementos que la dimensión explícita fijada en su declaración.",
        "ejemplo_correcto": "int arr[3] = {1, 2, 3};",
        "ejemplo_incorrecto": "int arr[3] = {1, 2, 3, 4}; // Excede dimensión",
        "autofix": "No",
    },
    "0x002Bh": {
        "codigo": "0x002Bh",
        "alias": "GAFF_0x002Bh",
        "titulo": "Validador de espaciado en listas de argumentos y llamadas a funciones",
        "categoria": "Sintaxis Básica y Nomenclatura (0x00XX)",
        "descripcion": "Toda coma en listas de parámetros o argumentos debe ir inmediatamente adherida al elemento anterior y seguida de un espacio en blanco ('f(a, b, c)').",
        "ejemplo_correcto": "calcular(x, y, z);",
        "ejemplo_incorrecto": "calcular(x,y,z);\ncalcular(x , y);",
        "autofix": "Sí",
    },
    "0x002Ch": {
        "codigo": "0x002Ch",
        "alias": "GAFF_0x002Ch",
        "titulo": "Auditor de consistencia en nombres de constantes simbólicas",
        "categoria": "Sintaxis Básica y Nomenclatura (0x00XX)",
        "descripcion": "Las constantes simbólicas declaradas con #define deben nombrarse enteramente en mayúsculas sostenidas con guiones bajos (SCREAMING_SNAKE_CASE).",
        "ejemplo_correcto": "#define BUFFER_SIZE 1024",
        "ejemplo_incorrecto": "#define buffer_size 1024\n#define Max_Len 256",
        "autofix": "No",
    },
    "0x002Dh": {
        "codigo": "0x002Dh",
        "alias": "GAFF_0x002Dh",
        "titulo": "Validador de espaciado en operadores unarios",
        "categoria": "Sintaxis Básica y Nomenclatura (0x00XX)",
        "descripcion": "No debe haber espacios entre los operadores unarios (*, &, !, ++, --) y su operando inmediato ('*ptr', '&var', '!flag', '++i').",
        "ejemplo_correcto": "*ptr = 5;\nif (!condicion) ++i;",
        "ejemplo_incorrecto": "* ptr = 5;\nif (! condicion) ++ i;",
        "autofix": "No",
    },
    "0x1016h": {
        "codigo": "0x1016h",
        "alias": "GAFF_0x1016h",
        "titulo": "Detector de expresiones booleanas complejas sin paréntesis aclaratorios",
        "categoria": "Estructuras de Control y Lazos (0x10XX)",
        "descripcion": "Cuando se combinan operadores lógicos '&&' y '||' en una misma expresión, es obligatorio usar paréntesis para explicitar la precedencia pedagógica.",
        "ejemplo_correcto": "if ((a && b) || c)",
        "ejemplo_incorrecto": "if (a && b || c)",
        "autofix": "No",
    },
    "0x1017h": {
        "codigo": "0x1017h",
        "alias": "GAFF_0x1017h",
        "titulo": "Detector de operadores de incremento o decremento múltiples en una misma expresión",
        "categoria": "Estructuras de Control y Lazos (0x10XX)",
        "descripcion": "Modificar la misma variable más de una vez mediante operadores de incremento o decremento dentro de una misma sentencia provoca comportamiento indefinido.",
        "ejemplo_correcto": "i++;\nj++;\nx = i + j;",
        "ejemplo_incorrecto": "x = i++ + ++i;",
        "autofix": "No",
    },
    "0x2016h": {
        "codigo": "0x2016h",
        "alias": "GAFF_0x2016h",
        "titulo": "Detector de bloques else superfluos tras sentencias terminales",
        "categoria": "Funciones y Modularización (0x20XX)",
        "descripcion": "Si la rama 'if' finaliza con una sentencia incondicional de salida ('return', 'exit', 'break'), el bloque 'else' es superfluo y agrega anidamiento innecesario.",
        "ejemplo_correcto": "if (error) {\n    return -1;\n}\nprocesar();",
        "ejemplo_incorrecto": "if (error) {\n    return -1;\n} else {\n    procesar();\n}",
        "autofix": "No",
    },
    "0x301Ah": {
        "codigo": "0x301Ah",
        "alias": "GAFF_0x301Ah",
        "titulo": "Validador de uso idiomático de tipos booleanos estándar",
        "categoria": "Tipos de Datos, Memoria y Punteros (0x30XX)",
        "descripcion": "Se debe utilizar el tipo estándar 'bool', 'true' y 'false' de <stdbool.h> en lugar de redefiniciones manuales obsoletas como 'typedef int BOOLEAN' o '#define TRUE 1'.",
        "ejemplo_correcto": "#include <stdbool.h>\nbool activo = true;",
        "ejemplo_incorrecto": "typedef int BOOL;\n#define TRUE 1\n#define FALSE 0",
        "autofix": "No",
    },
}
